...
### Docker Deployment
- Pull the image: `docker pull agentn613/mcpcloud`.
- Run with default settings: `docker run -p 3000:3000 agentn613/mcpcloud`.
- Run with custom config: `docker run -p 3000:3000 -v ./mcp_settings.json:/app/mcp_settings.json -v ./data:/app/data agentn613/mcpcloud`.
