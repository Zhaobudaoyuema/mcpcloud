...
// node_modules/@agentn613/mcpcloud/ (or @samanhappy/mcphub)
//   - dist/
//   - bin/
//   - frontend/dist/
  ...
  for (const root of possibleRoots) {
    ...
    if (fs.existsSync(packageJsonPath)) {
      try {
        ...
        if (pkg.name === 'mcphub' || pkg.name === '@samanhappy/mcphub' || pkg.name === '@samanhappy/mcpcloud' || pkg.name === '@agentn613/mcpcloud') {
          if (isDebug) {
