...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="mb-4 font-serif text-2xl font-semibold text-warm-ink">{t('pages.dashboard.title')}</h1>
        ...
        <div className="space-y-8" aria-busy="true" aria-live="polite">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
            {Array.from({ length: 5 }).map((_, index) => (
              <div key={`stats-skeleton-${index}`} className="dashboard-card p-6">
          ...
          <div>
            ...
            <div className="table-container overflow-hidden rounded-warm-card bg-warm-cream shadow-warm-sm">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="dashboard-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-base font-medium text-warm-warmGray">
                  {t('pages.dashboard.totalServers')}
                </h2>
                <p className="text-3xl font-semibold text-warm-ink">{serverStats.total}</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-3xl font-semibold text-warm-ink">{serverStats.online}</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-3xl font-semibold text-warm-ink">{serverStats.disabled}</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-3xl font-semibold text-warm-ink">{serverStats.offline}</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-3xl font-semibold text-warm-ink">{serverStats.connecting}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {allServers.length > 0 && !showSkeleton && (
        <div className="mt-8">
          <h2 className="mb-3 font-serif text-xl font-semibold text-warm-ink">
