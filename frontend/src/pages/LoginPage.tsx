...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="login-container relative min-h-screen w-full overflow-hidden">
      {/* Top-right controls */}
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(60rem 60rem at 20% -10%, rgba(212,165,116,0.22), transparent), radial-gradient(50rem 50rem at 120% 10%, rgba(139,90,43,0.18), transparent)',
        }}
      />
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        >
          ...
          <rect width="100%" height="100%" fill="url(#grid)" className="text-warm-camel/60 dark:text-gray-300" />
        </svg>
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-md items-center justify-center px-6 py-16">
        <div className="w-full space-y-16">
          ...
          <div className="flex w-full justify-center">
            <h1 className="font-serif text-3xl font-semibold leading-tight tracking-tight text-warm-ink sm:text-4xl">
              {t('auth.slogan')}
            </h1>
          </div>

          {/* Centered login card */}
          <div className="login-card relative w-full p-8">
            <div className="absolute -top-24 right-12 h-40 w-40 -translate-y-6 rounded-full bg-warm-terracotta/25 blur-3xl" />
            <div className="absolute -bottom-24 -left-12 h-40 w-40 translate-y-6 rounded-full bg-warm-caramel/15 blur-3xl" />
