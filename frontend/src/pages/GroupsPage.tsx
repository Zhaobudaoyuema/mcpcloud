...
const GroupsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {groupError && (
        <div className="error-box mb-6 rounded-warm-card border border-red-500/40 bg-red-50/90 p-4">
          <p>{groupError}</p>
        </div>
      )}

      {groupsLoading ? (
        <div className="loading-container page-card p-6">
        ...
        <div className="empty-state rounded-warm-card border border-warm-camel/40 bg-warm-cream p-6 shadow-warm-sm">
          <p className="text-warm-warmGray">{t('groups.noGroups')}</p>
        </div>
      ) : (
