            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {activities.map((activity) => (
                <tr key={activity.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-gray-200">
                    <span className="font-mono rounded text-xs bg-warm-beige text-warm-ink dark:bg-gray-700 dark:text-gray-100 px-2 py-1">
                      {activity.tool}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-900 dark:text-gray-200 whitespace-nowrap">
                  ...
                  <td className="px-4 py-3 text-sm">
                    <button
                      ...
                      className="text-warm-caramel hover:text-warm-rust dark:text-warm-caramel dark:hover:text-warm-terracotta"
                    >
                      {t('common.view')}
                    </button>
                  </td>
