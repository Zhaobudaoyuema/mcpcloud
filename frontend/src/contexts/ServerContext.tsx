...
export const ServerProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // When not authenticated we keep polling for public read-only view (GET /servers is allowed without auth)
  }, [auth.isAuthenticated]);

  useEffect(() => {
    // Fetch and poll servers for both authenticated and unauthenticated users (public read-only GET is allowed)
