...
export const SettingsProvider: React.FC<SettingsProviderProps> = ({ children }) => {
  ...
  const [mcpRouterConfig, setMCPRouterConfig] = useState<MCPRouterConfig>({
    apiKey: '',
    referer: 'https://www.mcpcloud.com',
    title: 'MCPCloud',
    ...
    try {
      ...
      if (data.success && data.data?.systemConfig?.mcpRouter) {
        setMCPRouterConfig({
          ...
          referer: data.data.systemConfig.mcpRouter.referer || 'https://www.mcpcloud.com',
          title: data.data.systemConfig.mcpRouter.title || 'MCPCloud',
