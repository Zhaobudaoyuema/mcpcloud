      ...
      <div className="relative z-10 flex-1 flex flex-col">
        <div className="mb-3 flex items-start justify-between">
          <div className="flex-1">
            <h3 className="mb-2 line-clamp-2 text-lg font-semibold text-warm-ink transition-colors duration-200 group-hover:text-warm-caramel">
              {server.title || server.name}
            </h3>

            {/* Author Section */}
            <div className="mb-2 flex items-center space-x-2">
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-warm-terracotta text-xs font-semibold text-warm-cream">
                {getAuthorInitials(server.author_name)}
              </div>
              <div>
                <p className="text-sm font-medium text-warm-warmGray">{server.author_name}</p>
                {server.updated_at && (
                  <p className="text-xs text-warm-warmGray">
        ...
        <div className="mb-3 flex-1">
          <p className="text-sm leading-relaxed text-warm-warmGray line-clamp-2">
