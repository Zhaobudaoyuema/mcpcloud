...
const badgeVariants = {
  default: 'bg-warm-caramel text-warm-cream hover:bg-warm-terracotta',
  secondary:
    'bg-warm-cream text-warm-ink dark:bg-gray-700 dark:text-gray-300 hover:bg-warm-beige dark:hover:bg-gray-600',
  outline:
    'bg-transparent border border-warm-camel/60 dark:border-gray-600 text-warm-ink dark:text-gray-300 hover:bg-warm-beige/60 dark:hover:bg-gray-800',
