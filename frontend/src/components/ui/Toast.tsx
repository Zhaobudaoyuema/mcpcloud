...
const Toast: React.FC<ToastProps> = ({
  ...
  const bgColors = {
    ...
    info: 'bg-warm-beige/90 border-warm-camel/50',
        ...
        <div className="ml-auto pl-3">
          <div className="-mx-1.5 -my-1.5">
            <button
              onClick={onClose}
              className={cn(
                'inline-flex rounded-md p-1.5 hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-warm-caramel',
              )}
            >
